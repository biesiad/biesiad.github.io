...
views.spot = {
    ...
    initMap: function (position) {
        ...
        self.map = L.map('map').setView([position.latitude, position.longitude], 16);
        ...
        self.marker = L.marker([position.latitude, position.longitude]).addTo(self.map);
        self.map.on('move', function () { self.updateMarker(); });
    },
    resizeMap: function () {
    ...
    updateMarker: function () {
        ...
        this.share.attr('href', '#share/' + btoa(center.lat + '|' + center.lng));
    }
};
